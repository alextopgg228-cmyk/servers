...
Вход работает на стороне браузера, чтобы сайт запускался на GitHub Pages:

- Админ: `admin` / `admin123`
- Работник: `worker` / `worker123`
- Покупатель: `customer` / `customer123`

Админ видит все разделы, экспорт, сброс и удаление заказов. Работник работает с заказами и справочниками без удаления. Покупатель видит только проверку статуса ремонта по ФИО или серийному номеру.
